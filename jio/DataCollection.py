...
with open('/data/data/com.termux/files/home/jio_pingdata/jio/final_domains.txt', 'r') as file:
...
day_dir = os.path.join('/data/data/com.termux/files/home/jio_pingdata/jio/data/', date_str)
